...
def ans1_kb():
    ...
    but3 = telebot.types.InlineKeyboardButton('Университеты с высоким проходным баллом', callback_data='false1')
...
def ans2_kb():
    ...
    but3 = telebot.types.InlineKeyboardButton('Проходной балл не имеет значения, если сдаешь все экзамены на высокий балл', callback_data='false2')
...
def ans3_kb():
    ...
    but2 = telebot.types.InlineKeyboardButton('Только высокие проходные баллы на конкурс',callback_data='false3')
